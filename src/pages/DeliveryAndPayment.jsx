        ...
        <div className='shopandpay_content'>
          ...
          <div className='shopandpay_content_flex'>
            ...
            <p>
              ...
              не только по всем городам России, но и в страны СНГ. Понимаем, что
              оперативность в нашем деле на первом месте и поэтому стараемся
              доставить продукцию в максимально сжатые сроки. Возможна
              экспресс-поставка комплектующих из стран Европы по
            ...
            <p>
              ...
              помещение 306. каб. 24-8. Доставка по городу и области проводится
              согласно принятых тарифов силами производителя или с привлечением
              курьерских компаний в сжатые сроки (от одного до двух дней). -При
              заказе до 10 000 рублей доставка по Санкт-Петербургу — 300 рублей
              -При заказе более 10 000 рублей доставка предоставляется
              бесплатная в пределах СПб и КАД Наша служба логистики поможет
              подобрать самый оптимальный вариант доставки для вас с учетом
              сроков и стоимости услуг.
            </p>
          </div>
        </div>
        <div className='shopandpay_content'>
          ...
          <div className='shopandpay_content_flex'>
            ...
            <p>
              ...
              действующего законодательства РФ. Наши клиенты имею право обменять
              товар на аналогичный или вернуть его в течение 14 дней, не считая
              дня покупки:
            </p>
            <ul>
              <li>
            ...
            <p>
              ...
              обмен товара надлежащего качества должны быть сохранены товарный
              вид продуктов, целостность упаковки и комплектация заказа. В
              случае повреждения или наличия следов эксплуатации Вам может быть
