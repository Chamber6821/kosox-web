      ...
      <main>
        <div className='product_page content'>
          <div className='product_page_about '>
            <div className='product_page_about_img'>
              <div className='product_page_about_img_bg'></div>
            </div>
        ...
        <div className='product_page_description'>
          <div className='product_page_description_menu'>
            ...
            >
              <img
                className='img_texteditor'
                src='./img/texteditor.svg'
                alt=''
              />
          ...
          <div className='produce_page_description_text content'>
            <p>
              В нашей компании Вы можете купить MGB — Бесшпоночная зажимная
              муфта (втулка) BK71 150×200 оптом и в розницу, а так же другие
              комплектующим, представленные в нашем каталоге. Тип KLDB, RCK71,
              KTR200 относится к быстрозажимным типам. Их производят для
              установки на вал электродвигателя особой плотности. Соединение при
              этом безлюфтовое. Не требует применения особых инструментов.
              Монтаж проводится за несколько минут. Простота использования
              заключается в том, что втулки не образуют зазоров из-за отсутствия
              шлиц. Основным элементом служат разрезные конусы. При стягивании
              крепежных элементов они плотно стягиваются. Во время данного
              действия, происходит радиальная деформация и внутреннее кольцо
              уменьшается. Изделие создается из углеродистой стали, что
              обеспечивает ему высокую прочность и долговечность. Втулки
              упрощают техническое обслуживание всего механизма.
            </p>
