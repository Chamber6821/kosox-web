        ...
        <div className='shopandpay'>
          <div className='shopandpay_content'>
            <div className='shopandpay_content_flex'>
              <p>
                Наш компания — это не просто поставщик подшипников и
                комплектующих для промышленности, всегда готовый удовлетворить
                потребности оптовых и розничных покупателей. Мы — это команда
                профессионалов, которым удалось создать и успешно внедрить на на
                рынок на СОБСТВЕННЫЙ БРЕНД — MGB. Благодаря опыту и знаниям, мы
                четко понимаем, как устроен рынок продукции и знаем, что
          ...
          <div className='shopandpay_content'>
            ...
            <div className='shopandpay_content_flex'>
              ...
              <ul>
                <li>
                  -Торговые компании, которые занимаются реализацией
                  комплектующих
                </li>
                <li>
                ...
                <li>
                  -Конечный потребитель, который использует наши комплектующие
                  для ремонта своего оборудования
                </li>
              </ul>
              <p>Наши цели:</p>
              <ul>
              ...
              <p>
                ...
                индивидуальные скидки, гибкие условия оплаты (50/50, постоплата)
                и индивидуальное хранение продукции на складе под клиента.
              </p>
            </div>
          </div>
        </div>
