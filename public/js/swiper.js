  ...
  const ue = [
    ...
    function (e) {
      ...
      function C() {
        ...
        t.params.uniqueNavElements &&
          ...
          a &&
            ((r = a.querySelector(se(t.params.scrollbar.dragClass))),
    ...
    function (e) {
      ...
      function P(e) {
        ...
        1 === p && z && ((a = void 0), (r = void 0)),
          (s.scale =
            z || m.imageWrapEl.getAttribute("data-swiper-zoom") || i.maxRatio),
          (p =
            z || m.imageWrapEl.getAttribute("data-swiper-zoom") || i.maxRatio),
          !e || (1 === p && z)
            ? ((u = 0), (g = 0))
    ...
    function (e) {
      ...
      function h(e) {
        ...
        (t.pagination &&
          ...
          t.pagination &&
            i.matches(se(t.params.pagination.bulletClass)) &&
            i.click());
      }
      function f() {
        return (
          ...
          setTranslate: () => {
            ...
            for (let e = 0, s = i.length; e < s; e += 1) {
              ...
              if (
                ...
                e || (e = ce("coverflow", s, n ? "left" : "top")),
                  t || (t = ce("coverflow", s, n ? "right" : "bottom")),
        ...
        setTranslate: () => {
          ...
          for (let s = 0; s < e.length; s += 1) {
            ...
            if ((h && f.shadow) || !h) {
              ...
              if ((!e && f.shadow && (e = ce("creative", i)), e)) {
  ...
  function fe(e, t) {
    ...
    Object.keys(t)
      ...
      .forEach((s) => {
        void 0 === e[s]
          ? (e[s] = t[s])
          : he(t[s]) && he(e[s]) && Object.keys(t[s]).length > 0
          ? t[s].__swiper__
            ? (e[s] = t[s])
            : fe(e[s], t[s])
          : (e[s] = t[s]);
  ...
  "undefined" != typeof window &&
    ...
    "undefined" != typeof window &&
      (window.customElements.get("swiper-container") ||
        window.customElements.define("swiper-container", Te),
